...
import ija.model.board.AbstractFactorySolitaire;
import ija.model.board.FactoryKlondike;
...
public class TestAll {
    ...
    public static void main(String[] args) {
        ...
        tester.testCard();
        tester.testCardDeck();
        tester.testTargetPack();
        tester.testWorkingPack();
        tester.testWorkingPack2();
    }
