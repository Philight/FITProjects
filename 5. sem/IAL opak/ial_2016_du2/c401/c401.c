...
**/
	...
	// Current Key is higher than the needed key
		return BSTSearch(RootPtr->LPtr, K, Content);

	else if (RootPtr->Key < K)
	// Current Key is lower than the needed key
...
**/
	if ((*RootPtr) != NULL)
	{
		...
		// Rightmost node found
		{
			...
			tBSTNodePtr TempPtr = *RootPtr; // temporary pointer
			
			if ((*RootPtr)->LPtr != NULL)
			// it has a left sub-node
...
**/
	if (*RootPtr != NULL)
	{
		...
		// node found
		{
			...
			else // deleted node has both sub-nodes
